...
} from '@aneeshbhat/react-color-picker'
...
export default function App() {
  ...
  const [hideGradientTypeSwitcher, setHideGradientTypeSwitcher] = useState(false)
  ...
  const [activeGradientType, setActiveGradientType] =
    useState<ReactColorPickerGradientType>('linear')
  const [useDefaultGradientType, setUseDefaultGradientType] = useState(false)
    ...
    <>
      ...
      <main
        style={{
          ...
          background: color ? color : 'linear-gradient(90deg, #f8ffa9 0.03%, #ffcaca 100%)',
        }}
      >
        <section style={{ width: 'min(100%, 1100px)', padding: '0 16px', boxSizing: 'border-box' }}>
          <h1 style={{ marginBottom: '16px', color: 'white', mixBlendMode: 'difference' }}>
            React Color Picker
          </h1>
          ...
          <div className="layout">
            ...
            <div className="picker-col">
              <ReactColorPicker
                ...
                hideGradientTypeSwitcher={hideGradientTypeSwitcher}
                defaultMode="solid"
            ...
            <div className="customize-col">
              ...
              <div className="customize-card">
                ...
                />
                <Checkbox
                  label="Hide Gradient Type Switcher"
                  subtext={`hideGradientTypeSwitcher={${hideGradientTypeSwitcher}}`}
                  checked={hideGradientTypeSwitcher}
                  onChange={setHideGradientTypeSwitcher}
                />
                <Checkbox
                ...
                <Checkbox
                  label="Set Default Gradient Type"
                  checked={useDefaultGradientType}
                  onChange={setUseDefaultGradientType}
                />
                {useDefaultGradientType && (
                  <Dropdown
                    label="Default Gradient Type"
                    subtext={`defaultGradientType="${activeGradientType}"`}
                    value={activeGradientType}
                    options={['linear', 'radial']}
                    onChange={setActiveGradientType}
                  />
                )}
              </div>
            </div>
            ...
            <div className="code-col">
              <CodeViewer
                ...
                useDefaultGradientType={useDefaultGradientType}
                defaultGradientType={activeGradientType}
              />
            </div>
          </div>
        </section>
        ...
        >
          <a
            href="https://www.npmjs.com/package/@aneeshbhat/react-color-picker"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/aneeshbhatb/react-color-picker"
            target="_blank"
            rel="noreferrer"
          >
